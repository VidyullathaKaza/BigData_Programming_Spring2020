...
object SQLdf {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read
      ...
      .load("/Users/madhurisarode/Downloads/WordCount_Latest/survey.csv")


    //df.show()

    df.write.format("csv").option("header","true").save("/Users/madhurisarode/Downloads/WordCount_Latest/output")
    ...
    val lines = sc.textFile("/Users/madhurisarode/Downloads/WordCount_Latest/survey.csv")
